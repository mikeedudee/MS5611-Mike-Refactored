...
void loop()
{
  ...
  Serial.print("T: ");
  Serial.print(ONE.readTemperature(), 2);
  Serial.print("\tP: ");
  Serial.print(ONE.readPressure(), 2);
  Serial.print("\tT: ");
  Serial.print(TWO.readTemperature(), 2);
  Serial.print("\tP: ");
  Serial.print(TWO.readPressure(), 2);
  Serial.print("\tT: ");
  Serial.print(ONE.readTemperature() - TWO.readTemperature(), 2);
  Serial.print("\tP: ");
  Serial.print(ONE.readPressure() - TWO.readPressure(), 2);
  Serial.println();
